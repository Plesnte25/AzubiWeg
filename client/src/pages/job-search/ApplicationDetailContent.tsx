...
/** The application detail body — shared by ApplicationDetailModal (lg,
 * centered dialog) and ApplicationDetailSheet (sm/md, full-page view). Each
 * wrapper supplies its own chrome (Modal vs. full-page header) around this. */
export function ApplicationDetailContent({ id, onClose }: { id: string; onClose: () => void }) {
