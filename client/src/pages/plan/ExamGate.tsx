...
export default function ExamGate() {
  ...
  return (
    <div
      ...
      style={{ background: "radial-gradient(110% 44% at 50% 8%, var(--color-ink-50) 0%, var(--color-paper) 66%)" }}
    >
      ...
      <div className="mt-[26px] grid place-items-center">
        <div className="grid size-[74px] place-items-center rounded-[22px]" style={{ background: "var(--color-brand-50)", boxShadow: "0 0 0 1px color-mix(in srgb, var(--color-brand-700) 45%, transparent)" }}>
          <FlagPennant size={34} weight="regular" style={{ color: "var(--color-brand-700)" }} aria-hidden="true" />
        </div>
      </div>

      <div className="mt-[18px] text-center">
        <div className="text-micro tracking-[.14em] uppercase" style={{ color: "var(--color-brand-700)" }}>
        ...
        <div className="mt-1.5 text-[13px] leading-[1.5]" style={{ color: "var(--color-ink-600)" }}>
          {alreadyPassed
      ...
      <div className="mt-[22px] grid grid-cols-3 gap-2">
        <div className="items-start rounded-xl p-3" style={{ background: "var(--color-card)" }}>
          <ListChecks size={16} weight="regular" style={{ color: "var(--color-brand-500)" }} aria-hidden="true" />
        ...
        <div className="items-start rounded-xl p-3" style={{ background: "var(--color-card)" }}>
          <Timer size={16} weight="regular" style={{ color: "var(--color-brand-500)" }} aria-hidden="true" />
        ...
        <div className="items-start rounded-xl p-3" style={{ background: "var(--color-card)" }}>
          <Target size={16} weight="regular" style={{ color: "var(--color-brand-500)" }} aria-hidden="true" />
      ...
      <div className="mt-[22px]">
        ...
        <div className="flex flex-col gap-2">
          {SECTION_ORDER.map((s) => {
            ...
            return (
              <div key={s} className="flex items-center gap-3 rounded-[11px] p-3" style={{ background: "var(--color-ink-50)" }}>
                <Icon size={17} weight="regular" style={{ color: "var(--color-ink-600)" }} aria-hidden="true" />
      ...
      <div className="mt-auto pt-5 pb-[100px]">
        <div className="mb-3 flex items-start gap-2 text-[11.5px] leading-[1.5]" style={{ color: "var(--color-ink-600)" }}>
